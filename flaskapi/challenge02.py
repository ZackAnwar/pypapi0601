...
@app.route("/veg")
def veg():
    if request.args.get("vegetables"):
        vegeq = request.args.get("vegetables")
    else:
        return "Pass Parameter vegetables"

    if vegeq == "onions":
        return"Yes, good for cooking"
    elif vegeq == "okra":
        return "tastes good when fried"
    elif vegeq == "carrots":
        return
        "good for salad"
    else:
